            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="ml-2 btn btn-primary btn-xs" onclick="tambah_penumpang()">
                            <span class="fas fa-plus-square"></span> Tambah Penumpang
                        </button>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="formTambah" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="pilih_trayek_tambah">Trayek:</label>
                        <select class="form-control" id="pilih_trayek_tambah" name="pilih_trayek_tambah">
                    ...
                    <div class="form-group">
                        <label for="tempat_duduk_tambah">Tempat Duduk: </label>
                        <select class="custom-select" id="tempat_duduk_tambah" name="tempat_duduk_tambah">
                            <div class="form-control form-control-user" aria-labelledby="tempat_duduk_tambah">
...
<div class="modal fade" id="formEditModal" tabindex="-1" role="dialog" aria-labelledby="formEditModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formEditModalLabel">Form Edit Penumpang</h5>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select" id="tempat_duduk" name="tempat_duduk" disabled>
                                    <div class="form-control form-control-user" aria-labelledby="tempat_duduk">
                                        <?php $stat = array('1_1', '2_1', '2_2', '2_3', '3_1', '3_2', '3_3'); ?>
                                        <option value=""> -- Pilih Tempat Duduk -- </option>
                                        <?php for ($i = 0; $i < count($stat); $i++) { ?>
                                            <option value=<?= $stat[$i]  ?>><?= $stat[$i] ?> </option>
                                        <?php } ?>
                        ...
                        <div class="col-sm-6">
                            <h7>Bukti Pembayaran: </h7><br>
                            <img id="bukti_pembayaran" class="img-fluid mt-3" src="">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" id="btnUpdate" onclick="update_penumpang()" class="btn btn-primary">Edit</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                </div>
            </form>
        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#pilih_trayek_tambah").change(function() {
            var val = $(this).val();
            var options = '';
            <?php
            $result = array();
            foreach ($daftar_trayek as $d) : ?>
                if (val == 0) {
                    $('#tempat_duduk_tambah').empty().append('<option value="">-- Pilih Tempat Duduk --</option>');
                } else if (val == <?= $d['id_trayek'] ?>) {
                    <?php
                    unset($result);
                    $result = array();

                    $sisa = explode(',', $d['sisa_tempat_duduk']);

                    for ($i = 0; $i < count($sisa); $i++) {
                        array_push($result, $sisa[$i]);
                    }
                    ?>
                    ...
                    $('#tempat_duduk_tambah').append(options);
                }
            <?php endforeach; ?>
    ...
    function edit_penumpang(id_penumpang) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var imgUrl = "<?php echo site_url('assets/images/bukti/') ?>" + data.bukti_pembayaran;
                var mainUrl = document.getElementById('bukti_pembayaran');
                mainUrl.src = imgUrl;
