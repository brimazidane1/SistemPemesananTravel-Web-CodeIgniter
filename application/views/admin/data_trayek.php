            ...
            <div class="col">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Trayek</h3>
                        <button class="ml-2 btn btn-primary btn-xs" onclick="tambah_trayek()">
                            <span class="fas fa-plus-square"></span> Tambah Trayek
                        </button>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="pilih_armada" name="pilih_armada">
                            ...
                            <?php foreach ($daftar_armada as $d) : ?>
                                <option value="<?= $d['id_armada'] ?>"><?= $d['nama_travel'] . " - " . $d['mobil'] . " - " . $d['no_pol'] ?></option>
                            <?php endforeach; ?>
                        </select>
...
<div class="modal fade" id="formEditModal" tabindex="-1" role="dialog" aria-labelledby="formEditModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formEditModalLabel">Form Edit Trayek</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
    ...
    function edit_trayek(id_trayek) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('[name="tanggal"]').datepicker().val(data.tanggal);
